...
import {manejarEnvioComentario, agregarComentario, usuarioEsAdmin, agregarRespuesta,configurarObtencionComentarios} from './comentario.js';
import {mostrarElemento, ocultarElemento, limpiarFormulario,obtenerDatosFormulario,validarCorreo,validarContraseña} from './utils.js'
...
//     //alternar el tipò de input entre password y test
//     const tipo = contraseñaInput.type === 'password' ? 'text' : 'password';
//     contraseñaInput.type = tipo;

//     //cambiar la imagen del ojo
//     togglePassword.src = tipo === 'password' ? 'Imagenes/ojo-cerrado.png' : 'Imagenes/ojo-abierto.png';
//     // togglePassword.alt = tipo === 'password' ?  'Mostrar contraseña' : 'Ocultar contraseña';
// });
